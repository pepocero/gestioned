...
document.getElementById("select-stats").innerHTML = 'Seleccione un profesor de la tabla';



//TABLA TABULATOR BUSCAR PROFESOR-------------------------------------------------------
var table = new Tabulator("#example-table", {
ajaxURL:"../ajax/ver_profesores.php", //ajax URL
//ajaxConfig:"POST", //ajax HTTP request type
//ajaxParams:{control:"get_profesores",idProfe:idProfe}, //ajax parameters
layout:"fitDataFill",
