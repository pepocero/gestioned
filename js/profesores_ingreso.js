...
$("#btn_add_campo").click(function(){
    ...
    var control = "add_campo_profesores";
    sweetAjaxInput(title, urlAjax, control,0);
});

//DE CHATGPT PARA GENERAR EL FORMULARIO DE INGRESO DE ALUMNOS DE FORMA DINAMICA
fetch("../ajax/ingreso.php?control=profesores")
