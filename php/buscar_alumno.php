...
<div class="alert alert-warning alert-dismissible fade show col-4 mx-auto" role="alert">
  <strong>¡Atención!</strong> Para ver la ficha de un alumno, primero debe buscarlo en la tabla de abajo. <strong>Doble clic para acceder.</strong>
...
<form method="POST" action="alumno_ficha.php" id="formStudent">
   <input type="text" id="idAlumno" name="idAlumno" hidden="true" value="">      
</form> 
